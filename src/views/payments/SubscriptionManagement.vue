    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="flex justify-content-between align-items-center mb-4">
          <div>
            <h1 class="text-3xl font-bold text-900 mb-2">Gestión de Suscripciones</h1>
            <p class="text-600 m-0">Administra tu suscripción y plan actual</p>
          </div>
        ...
        <div v-if="currentSubscription" class="current-subscription-section">
            ...
            <div class="subscription-details">
              <div class="detail-grid">
                ...
                <div class="detail-item">
                  ...
                  <span class="detail-value">{{ getPaymentMethodText() }}</span>
                </div>
                <div class="detail-item">
                  <span class="detail-label">Fecha de inicio</span>
                  <span class="detail-value">{{ formatDate(currentSubscription.created_at) }}</span>
                </div>
                <div class="detail-item">
                  <span class="detail-label">ID de suscripción</span>
                  <span class="detail-value subscription-id">{{ currentSubscription.id }}</span>
                </div>
              </div>
            </div>
          ...
          <div class="usage-grid">
            <div class="usage-card">
              ...
              <div class="usage-stats">
                <span class="usage-current">{{ usage.groups_count || 0 }}</span>
            ...
            <div class="usage-card">
              ...
              <div class="usage-stats">
                <span class="usage-current">{{ usage.exams_count || 0 }}</span>
            ...
            <div class="usage-card">
              ...
              <div class="usage-stats">
                <span class="usage-current">{{ usage.students_count || 0 }}</span>
        ...
        <div v-if="subscriptionHistory.length > 0" class="history-section">
          ...
          >
            ...
            <Column field="created_at" header="Fecha de Inicio" sortable>
              <template #body="{ data }">
                {{ formatDate(data.created_at) }}
              </template>
            </Column>
            <Column field="cancelled_at" header="Fecha de Cancelación">
              <template #body="{ data }">
                {{ data.cancelled_at ? formatDate(data.cancelled_at) : '-' }}
              </template>
            </Column>
            <Column field="plan.price_cents" header="Precio">
              <template #body="{ data }">
...
const getPaymentMethodText = () => {
  // TODO: Implement payment method display
  return 'Tarjeta terminada en ****1234'
}
...
const getUsagePercentage = (type: 'groups' | 'exams' | 'students') => {
  ...
  const current = usage.value[`${type}_count`] || 0
