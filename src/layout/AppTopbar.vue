    ...
    <div class="layout-topbar">
        ...
        <div class="layout-topbar-actions">
            ...
            <div class="relative">
                ...
                <div v-if="showNotifications" class="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-lg border z-50">
                    <div class="p-4 border-b">
                        <div class="flex justify-between items-center">
                            <h6 class="text-lg font-semibold">Notificaciones</h6>
                            <Button
                                v-if="hasUnread"
                    ...
                    <div class="max-h-96 overflow-y-auto">
                        ...
                        >
                            <div class="flex items-start gap-3">
                                <i class="pi pi-bell text-primary mt-1"></i>
                                <div class="flex-1">
                                ...
                                <div v-if="!notification.is_read" class="w-2 h-2 bg-primary rounded-full"></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="relative">
                ...
                <!-- Panel de usuario -->
                <div v-if="showUserMenu" class="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg border z-50">
                    <div class="p-4 border-b">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="font-semibold">{{ user?.name || 'Usuario' }}</div>
                    ...
                    <div class="py-2">
                        ...
                        <hr class="my-2">
                        <button
                            class="w-full px-4 py-2 text-left hover:bg-gray-50 dark:hover:bg-gray-700 flex items-center gap-3 text-red-600"
                            @click="handleLogout"
                        >
