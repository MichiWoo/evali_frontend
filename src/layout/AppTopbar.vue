    ...
    <div class="layout-topbar-actions">
      ...
      <div class="relative">
        ...
        <div
          ...
          class="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-gray-800 rounded-lg shadow-lg border z-50"
        >
      ...
      <div class="relative">
        ...
        <div
          v-if="showUserMenu"
          class="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg border z-50"
        >
          <div class="p-4 border-b">
