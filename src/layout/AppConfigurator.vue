...
function onPresetChange() {
    ...
    const presetValue = presets[preset.value as 'Aura' | 'Lara' | 'Nora'];
...
<template>
    <div
        ...
        style="position: absolute; top: 3.25rem; right: 0; width: 16rem; padding: 1rem; background-color: var(--surface-overlay); border: 1px solid var(--surface-border); border-radius: var(--content-border-radius); transform-origin: top; box-shadow: 0px 3px 5px rgba(0,0,0,0.02), 0px 0px 2px rgba(0,0,0,0.05), 0px 1px 4px rgba(0,0,0,0.08);"
    >
        <div style="display: flex; flex-direction: column; gap: 1rem;">
            ...
            <div class="config-panel-settings">
                <span class="config-panel-label">Menu Mode</span>
