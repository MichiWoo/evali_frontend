...
const baseModel = [
  ...
  {
    label: 'Estudiantes',
    items: [{ label: 'Lista de Estudiantes', icon: 'pi pi-fw pi-users', to: '/students' }],
  },
  {
    label: 'Notificaciones',
    items: [{ label: 'Todas las Notificaciones', icon: 'pi pi-fw pi-bell', to: '/notifications' }],
  },
  {
...
const studentMenu = [
  ...
  {
    label: 'Exámenes',
    items: [{ label: 'Mis Exámenes', icon: 'pi pi-fw pi-file', to: '/student/exams' }],
  },
  {
    label: 'Resultados',
    items: [{ label: 'Mis Resultados', icon: 'pi pi-fw pi-chart-bar', to: '/student/results' }],
  },
  {
    label: 'Notificaciones',
    items: [{ label: 'Todas las Notificaciones', icon: 'pi pi-fw pi-bell', to: '/notifications' }],
...
const teacherMenu = [
  ...
  {
    label: 'Preguntas',
    items: [{ label: 'Banco de Preguntas', icon: 'pi pi-fw pi-question-circle', to: '/questions' }],
  },
  {
    label: 'Grupos',
    items: [{ label: 'Mis Grupos', icon: 'pi pi-fw pi-sitemap', to: '/groups' }],
  },
  {
    label: 'Estudiantes',
    items: [{ label: 'Lista de Estudiantes', icon: 'pi pi-fw pi-users', to: '/students' }],
